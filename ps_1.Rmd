...
df_step1 <-
  ...
  ksmooth(x=get(type_df)$medianIncome,y=get(type_df)$medianHouseValue,kernel_type,bandwidth = h_n) %>% qDT()
...
qplot(data=ks_df2,x=x,y = medianHouseValue)
...
df_plot_ks1[gro %in% gro_sam] %>% ggplot() + geom_point(
